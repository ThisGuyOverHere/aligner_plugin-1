...
class UploadComponent extends Component {
    ...
    sourceConversion = async () => {
        ...
        if (uploadSource.name) {
            ...
            try {
                ...
                Sentry.captureException(new Error(`Error during source file conversion. File named: ${uploadSource.name}`));
                this.setState({
                    uploadSource: {
                        progress: 0,
                        status: 'error'
    ...
    targetConversion = async () => {
        ...
        if (uploadTarget.name) {
            ...
            try {
                ...
                Sentry.captureException(new Error(`Error during target file conversion. File named: ${uploadTarget.name} `));
                this.setState({
                    uploadTarget: {
                        progress: 0,
                        status: 'error'
    ...
    onDropSource = async (files) => {
        ...
        try {
            ...
            Sentry.captureException(new Error(`Error during source file upload.`));
    ...
    onDropTarget = async (files) => {
        ...
        try {
            ...
            Sentry.captureException(new Error(`error during target file upload.`));
            __insp.push(['tagSession', {error: "file_upload"}]);
            this.setState({
                uploadTarget: {
                    progress: 0,
    ...
    startAlignment = () => {
        ...
        httpCreateProject({
            ...
            Sentry.captureException(new Error(`error during project creation.`));
            this.setState({
                creationError: {
                    error: true,
                ...
                <div className="uploadCard ui grid">
                    ...
                    <div className="row" id="buttonRow">
                        ...
                        <div className="twelve wide column">
                            <h4>Matecat Aligner supports <span
                                onClick={this.onFormatsModalClick}> 69 file formats </span></h4>
